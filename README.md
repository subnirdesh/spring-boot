...
Inversion of Control means we don’t create or manage your objects directly — the framework does it for us. The framework controls the creation and lifecycle of objects (called beans) 
